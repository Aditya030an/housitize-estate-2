...
import { Building, House, LandPlot, HousePlus, X, Minus, Plus, SlidersHorizontal } from 'lucide-react';
...
const iconMap = { Building, House, LandPlot, HousePlus } as const;
...
const CategoryClient = () => {
  ...
  useEffect(() => {
    ...
    if (data) {
      try {
        ...
        const mappedData = parsedData.map((category: Category) => ({
          ...category,
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto max-w-[1400px] px-4 py-6 pt-24">
        ...
        <div className="sticky top-0 pt-4 z-10 bg-white flex items-center gap-8 overflow-x-auto pb-4 md:pb-6 no-scrollbar shadow-md">
          {categories.map((category) => {
            const IconComponent = category.icon as React.ElementType | null;
      ...
      {/* Filter Modal (same as your version, skipped here for brevity) */}
      {isOpen && (
                      ...
                      <div className="pt-8 pb-8">
                        <div className="relative h-1.5">
                          ...
                          <div
                            ...
                            style={{
                              left: `${
                                ((filterData.priceRange[0] - 500000) / 9500000) * 100
                              }%`,
                              width: `${
